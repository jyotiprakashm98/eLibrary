...
<%	
	...
	String query =" select * from Elibrary_RegistrationForm;";
...
%>
    ...
    <div class="wrapper">
        ...
        <div id="section">
            ...
            <div class="CMSRegistration-form">
		<table cols=1 border=1 cellspacing=7 cellpadding=7>
            <tr>
            ...
            <% while(result.next()) { %>
                <tr>
                    <% for(int i=1; i<=resultMD.getColumnCount(); i++) { %>
                    <td><center><font size="3px" face="arial" color="black">
					<%=result.getString(i)%>
					</font>
					</center></td>
                    <% } %>
